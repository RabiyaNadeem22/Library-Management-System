...
class data extends db{
    ...
    function addbook($bookpic, $bookname, $bookdetail, $bookaudor, $bookpub,  $bookprice, $bookquantity) {
       ...
       $q="INSERT INTO book (id,bookpic,bookname, bookdetail, bookaudor, bookpub,  bookprice,bookquantity,bookava,bookrent)VALUES('','$bookpic', '$bookname', '$bookdetail', '$bookaudor', '$bookpub', '$bookprice', '$bookquantity','$bookquantity',0)";
